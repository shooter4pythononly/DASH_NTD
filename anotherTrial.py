...
mapbox_access_token = 'pk.eyJ1Ijoicm9iaW5zdW5ueSIsImEiOiJjam50Nmh3ZW0wcW9zM3BwNmRjcjgyNjJ3In0.BL1Gs2sYSrUkEJ7soat4jg'
...
layout_map = dict(
    ...
    mapbox=dict(
        ...
        layers =  [
                ...
                {
                    'sourcetype': 'geojson',
                    'source': 'https://raw.githubusercontent.com/datameet/indian_village_boundaries/master/kl/kl.geojson',
                    'type': 'fill',
                ...
                {
                    'sourcetype': 'geojson',
                    'source': 'https://raw.githubusercontent.com/datameet/indian_village_boundaries/master/or/or1.geojson',
                    'type': 'fill',
